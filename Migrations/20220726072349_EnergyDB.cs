...
{
    public partial class EnergyDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SteamAvatar = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EAC", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsItem = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurentPlayers = table.Column<int>(type: "int", nullable: false),
                    Sleepers = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PromoCodeActivations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PromoCodeActivations_PromoCodes_PromoCodeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PromoCodeActivations_PromoCodeId",
                table: "PromoCodeActivations",
                column: "PromoCodeId");
