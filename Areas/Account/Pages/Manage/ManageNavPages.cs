...
namespace EnergyRust.Areas.Account.Pages.Manage
{
    public static class ManageNavPages
    {
        ...
        public static string PromoNavClass(ViewContext viewContext) => PageNavClass(viewContext, Promo);
        public static string IndexNavClass(ViewContext viewContext) => PageNavClass(viewContext, Index);
        public static string ShoppingCartNavClass(ViewContext viewContext) => PageNavClass(viewContext, ShoppingCart);
